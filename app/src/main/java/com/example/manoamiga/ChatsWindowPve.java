...
public class ChatsWindowPve extends AppCompatActivity {

    DatabaseReference databaseReference;
    ArrayList<chats> list;
    RecyclerView recyclerView;
    AdapterChats2 adapterChats;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chats_window_pve);
        ...
        list = new ArrayList<>();
        adapterChats = new AdapterChats2(list);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("vista").child("proveedores").child(uid);
